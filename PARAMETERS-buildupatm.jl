...
global const meanTs = 216.0
global const meanTt = 130.0
global const meanTe = 205.0
global const meantemps = [meanTs, meanTt, meanTe]

global const meanTsint = 216
global const meanTtint = 130
global const meanTeint = 205
...
global const lowTs = 160.0
global const hiTs = 270.0
global const lowTt = 100.0
global const hiTt = 160.0
global const lowTe = 150.0
global const hiTe = 250.0
...
const numiters = 15 # number of iterations per timestep. you can increase if having trouble converging

# Species, Jrates, and which are active ========================================

# !----------------- You may modify per simulation starting here -------------------!
const conv_neutrals = [:CO2];#, :O2, :H];
const conv_ions = [];

const new_neutrals = [:Ar, :CO, :H, :H2, :H2O, :H2O2, :HO2, :HOCO, :N2, 
                      :O, :O1D, :O2, :O3, :OH,
                      :D, :DO2, :DOCO, :HD, :HDO, :HDO2, :OD,];
const new_ions = [:CO2pl]; 
...
const newJrates = [# Original neutral photodissociation
...
global const speciescolor = Dict(:H => "#ff0000", :D => "#ff0000", # red
...
global const speciesstyle = Dict(:D => "--", :HD => "--", :OD => "--", :HDO => "--", :HDO2 => "--", :DO2 => "--", :DOCO => "--", 
...
#              # NEW .- Neutral reactions from Roger Yelle
             # [[:CO2, :H], [:CO, :OH], :(0)],  # KIDA: :(2.51e-10 .* exp.(-13300 ./ Tn))
