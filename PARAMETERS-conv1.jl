...
const N_species = [:N2, :N2O, :NO2, :CN, :HCN, :HNO, :N, :NH, :NH2, :NO]; # Classification purposes
...
# Set fixed species (no changes to density due to chemistry or transport) ========
const nochemspecies = [:Ar, :N2];
const notransportspecies = [:Ar, :N2]; 

append!(nochemspecies, conv_neutrals)
append!(notransportspecies, conv_neutrals)   
