...
function get_flux(sp::Symbol, atmdict::Dict{Symbol, Vector{Float64}}, Tn::Vector{Float64}, Ti::Vector{Float64}, Te::Vector{Float64}, Tp::Vector{Float64},  # params to pass
    ...
    Hs_dict = Dict{Symbol, Vector{Float64}}([sp=>scaleH(alt, sp, T_for_Hs[charge_type(sp)], molmass) for sp in allsp])  
...
function populate_xsect_dict(controltemps::Array, alts::Array; ion_xsects=true) # TODO: Put xsect file names into a large list argument. 
    #=
